...
export default function DailyRecordsBreakdownChart({ data }) {
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-soft p-5">
      <p className="text-sm font-semibold text-slate-700">Calls, Leads, Messages &amp; Appointments Entered</p>
      <p className="text-xs text-slate-400 mb-4">Daily breakdown — last 14 days</p>
