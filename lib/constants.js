...
export const HYDRA_FACIAL_DEFAULT_VISIBLE = [
  'full_name',
  'phone_number',
  'city',
  'lead_status',
...
export const HYDRA_FACIAL_EDITABLE = ['Call 01', 'Call 02', 'Call 03', 'Note', 'Treatment', 'Staff', 'C. Date'];
export const HYDRA_FACIAL_CHECKBOX_FIELDS = ['Call 01', 'Call 02', 'Call 03'];

export const HYDRA_FACIAL_COLUMNS = [
  { key: 'id', label: 'ID' },
  { key: 'created_time', label: 'Created Time' },
  { key: 'ad_id', label: 'Ad ID' },
  { key: 'ad_name', label: 'Ad Name' },
