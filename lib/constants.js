...
export const HYDRA_DEFAULT_VISIBLE = [
  'full_name',
  'phone_number',
  'city',
  'lead_status',
...
export const HYDRA_EDITABLE = ['Call 01', 'Call 02', 'Call 03', 'Note', 'Treatment', 'Staff', 'C. Date'];
export const HYDRA_CHECKBOX_FIELDS = ['Call 01', 'Call 02', 'Call 03'];

export const HYDRA_COLUMNS = [
  { key: 'id', label: 'ID' },
  { key: 'created_time', label: 'Created Time' },
  { key: 'ad_id', label: 'Ad ID' },
  { key: 'ad_name', label: 'Ad Name' },
  ...
  { key: 'Treatment', label: 'Treatment' },
  { key: 'Staff', label: 'Staff' },
  { key: 'C. Date', label: 'C. Date' },
];

export const LIP_BLUSHING_FILLERS_DEFAULT_VISIBLE = [
  'full_name',
  'phone_number',
  'city',
  'lead_status',
...
export const LIP_BLUSHING_FILLERS_EDITABLE = ['Call 01', 'Call 02', 'Call 03', 'Note', 'Treatment', 'Staff', 'con. date', 'Reason'];
export const LIP_BLUSHING_FILLERS_CHECKBOX_FIELDS = ['Call 01', 'Call 02', 'Call 03'];

export const LIP_BLUSHING_FILLERS_COLUMNS = [
  { key: 'created_time', label: 'Created Time' },
  { key: 'platform', label: 'Platform' },
  { key: 'are_you_18_years_of_age_or_older?', label: '18+?' },
  { key: 'what_is_the_best_time_to_contact_you?', label: 'Best Time to Contact' },
  ...
  { key: 'Treatment', label: 'Treatment' },
  { key: 'Staff', label: 'Staff' },
  { key: 'con. date', label: 'Con. Date' },
  { key: 'Reason', label: 'Reason' },
];

export const ENDOLIFT_DEFAULT_VISIBLE = [
  'full_name',
  'phone_number',
  'city',
  'lead_status',
...
export const ENDOLIFT_EDITABLE = ['Call 01', 'Call 02', 'Call 03', 'Note', 'Treatment', 'Staff', 'C. Date', 'Reason'];
export const ENDOLIFT_CHECKBOX_FIELDS = ['Call 01', 'Call 02', 'Call 03'];

export const ENDOLIFT_COLUMNS = [
  { key: 'created_time', label: 'Created Time' },
  { key: 'ad_id', label: 'Ad ID' },
  { key: 'ad_name', label: 'Ad Name' },
  { key: 'adset_id', label: 'Adset ID' },
  ...
  { key: 'are_you_18_years_of_age_or_older?', label: '18+?' },
  { key: 'what_is_the_best_time_to_contact_you?', label: 'Best Time to Contact' },
  { key: 'please_briefly_describe_what_you_would_like_to_enhance_or_improve._', label: 'Enhance / Improve' },
  { key: 'full_name', label: 'Full Name' },
  { key: 'phone_number', label: 'Phone Number' },
  { key: 'city', label: 'City' },
  { key: 'lead_status', label: 'Lead Status' },
...
export const ELDER_WOMENS_DEFAULT_VISIBLE = [
  'full_name',
  'phone_number',
  'city',
  'lead_status',
...
export const ELDER_WOMENS_EDITABLE = ['Call 01', 'Call 02', 'Call 03', 'Note', 'Treatment', 'Staff', 'C. Date', 'Reason'];
export const ELDER_WOMENS_CHECKBOX_FIELDS = ['Call 01', 'Call 02', 'Call 03'];

export const ELDER_WOMENS_COLUMNS = [
  { key: 'created_time', label: 'Created Time' },
  { key: 'ad_id', label: 'Ad ID' },
  { key: 'ad_name', label: 'Ad Name' },
  { key: 'adset_id', label: 'Adset ID' },
